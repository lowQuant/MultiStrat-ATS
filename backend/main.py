...
from routes.backtest import router as backtest_router, set_strategy_manager as set_backtest_strategy_manager
...
async def lifespan(app: FastAPI):
    ...
    set_backtest_strategy_manager(strategy_manager)
